...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Laporan Harian Tangki</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('daily-reports.update', $dailyReport->id) }}" method="POST">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror"
                            value="{{ old('tanggal', $dailyReport->tanggal->format('Y-m-d')) }}" required>
                        @error('tanggal')
                        ...
                        <select name="shift_id" class="form-select @error('shift_id') is-invalid @enderror" required>
                            ...
                            @foreach ($shifts as $shift)
                                <option value="{{ $shift->id }}"
                                    {{ old('shift_id', $dailyReport->shift_id) == $shift->id ? 'selected' : '' }}>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="totalisator_awal"
                            ...
                            value="{{ old('totalisator_awal', number_format($dailyReport->totalisator_awal, 3, ',', '.')) }}"
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="totalisator_akhir"
                            ...
                            value="{{ old('totalisator_akhir', number_format($dailyReport->totalisator_akhir, 3, ',', '.')) }}"
                            placeholder="Contoh: 1.437.500,500" required>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="stok_awal_mm"
                            ...
                            value="{{ old('stok_awal_mm', number_format($dailyReport->stok_awal_mm, 2, ',', '.')) }}"
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="stok_akhir_mm"
                            ...
                            value="{{ old('stok_akhir_mm', number_format($dailyReport->stok_akhir_mm, 2, ',', '.')) }}"
                            placeholder="Contoh: 1.150,75" required>
                ...
                <div class="card-footer d-flex justify-content-between py-6 px-0">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="ki-outline ki-check fs-2"></i> Update Laporan
                    </button>
                </div>
            </form>
        </div>
