                        ...
                        <form action="{{ route('salaries.update', $salary) }}" method="POST">
                            ...
                            <div class="mb-10">
                                ...
                                <input type="text" name="jumlah"
                                    ...
                                    value="{{ old('jumlah', number_format($salary->jumlah, 0, ',', '.')) }}" placeholder="0"
                                    required>
                                @error('jumlah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-10">
                                ...
                                <textarea name="keterangan" class="form-control" rows="3">{{ old('keterangan', $salary->keterangan) }}</textarea>
