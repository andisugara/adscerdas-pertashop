...
@section('title', 'Edit Penambahan Tangki')

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Penambahan Tangki (DO)</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('tank-additions.update', $tankAddition->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror"
                            value="{{ old('tanggal', $tankAddition->tanggal->format('Y-m-d')) }}" required>
                        @error('tanggal')
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="jumlah_liter"
                            ...
                            value="{{ old('jumlah_liter', number_format($tankAddition->jumlah_liter, 2, ',', '.')) }}"
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <textarea name="keterangan" rows="3" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $tankAddition->keterangan) }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
