                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        ...
                        @if ($deposit->bukti_setoran)
                            <div class="mt-3">
                                <div class="fw-semibold mb-2">Bukti saat ini:</div>
                                <a href="{{ asset('storage/' . $deposit->bukti_setoran) }}" target="_blank" class="btn btn-light-primary btn-sm">
                                    <i class="ki-outline ki-eye"></i> Lihat Bukti
                                </a>
                            </div>
                        @endif
